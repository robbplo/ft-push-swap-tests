...
/*   Updated: 2025/11/26 09:05:02 by rploeger         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	test_correct_index_desc(void)
{
	...
	// l: 5 3 1
	assert(correct_index_desc(l, 42) == 0);
	assert(correct_index_desc(l, 6) == 0);
	assert(correct_index_desc(l, 5) == 0);
	assert(correct_index_desc(l, 4) == 1);
	assert(correct_index_desc(l, 3) == 1);
	assert(correct_index_desc(l, 2) == 2);
	assert(correct_index_desc(l, 1) == 0);
	assert(correct_index_desc(l, 0) == 0);
	assert(correct_index_desc(l, -1) == 0);
	list_rotate(&l);
	// l: 3 1 5
	assert(correct_index_desc(l, 42) == 2);
	assert(correct_index_desc(l, 6) == 2);
	assert(correct_index_desc(l, 5) == 0);
	assert(correct_index_desc(l, 4) == 0);
	assert(correct_index_desc(l, 3) == 0);
	assert(correct_index_desc(l, 2) == 1);
	assert(correct_index_desc(l, 1) == 1);
	assert(correct_index_desc(l, 0) == 2);
	assert(correct_index_desc(l, -1) == 2);
	list_rotate(&l);
	// l: 1 5 3
	assert(correct_index_desc(l, 42) == 1);
	assert(correct_index_desc(l, 6) == 1);
	assert(correct_index_desc(l, 5) == 1);
	assert(correct_index_desc(l, 4) == 2);
	assert(correct_index_desc(l, 3) == 0);
	assert(correct_index_desc(l, 2) == 0);
	assert(correct_index_desc(l, 1) == 0);
	assert(correct_index_desc(l, 0) == 1);
	assert(correct_index_desc(l, -1) == 1);
	list_rotate(&l);
	// l: 5 3 1
	free(list_pop(&l));
